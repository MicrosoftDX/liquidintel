...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/c2a54db3e9247d3881668c3ca80e5b5284961db6/tedious/index.d.ts
...
export class Connection extends events.EventEmitter {
     ...
     * @param isolationLevel The isolation level that the transaction is to be run with.
     */
    transaction(callback: (error: Error, done: (error: Error, done: () => void) => void) => void, name?: string, isolationLevel?: ISOLATION_LEVEL): void;
